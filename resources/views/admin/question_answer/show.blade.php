            ...
            <div class="modal fade" id="update" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form method="post" action="{{ route('admin.answer.update') }}">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="row mb-1">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control">
                                            <option value="{{ $question_answer->question->title }}">{{ $question_answer->question->title }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-1">
                                    ...
                                    <div class="col-md-8">
                                        <input type="hidden" class="form-control" name="id" value="{{ $question_answer->id }}">
                                        <input type="text" class="form-control" name="title" value="{{ $question_answer->title }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" class="form-control" name="value" value="{{ $question_answer->value }}">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.answer.delete') }}" method="post">
                            @csrf
                            @method('DELETE')
                            <div class="modal-body">
                                <input type="checkbox" required value="{{ $question_answer->id }}" name="id"> Saya Setuju menghapus data ini
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>

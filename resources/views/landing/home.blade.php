        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="speaker-item">
                        ...
                        <div class="content text-center">
                            <h5><a href="single-speaker.html">Ir. Ns. Khairon, S.Kep, S.Kom</a></h5>
                            <p>Ketua</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="speaker-item">
                        <div class="image">
                            <img src="assets/theme/images/speakers/speaker-one.jpg" alt="speaker" class="img-fluid">
                            <div class="primary-overlay"></div>
                            <div class="socials">
                                <ul class="list-inline">
                                    <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="speaker-item">
                        <div class="image">
                            <img src="assets/theme/images/speakers/speaker-three.jpg" alt="speaker" class="img-fluid">
                            <div class="primary-overlay"></div>
                            <div class="socials">
                                <ul class="list-inline">
                                    <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="speaker-item">
                        <div class="image">
                            <img src="assets/theme/images/speakers/speaker-four.jpg" alt="speaker" class="img-fluid">
                            <div class="primary-overlay"></div>
                            <div class="socials">
                                <ul class="list-inline">
                                    <li class="list-inline-item"><a href="#"><i class="fa fa-facebook"></i></a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <!-- Section Title -->
                    <div class="section-title white">
                        <h3><span class="alternate">Seksi Pendidikan, Pelatihan dan Penelitian</span></h3>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">

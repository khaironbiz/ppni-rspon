...
@section('content')
    ...
    <div class="card ml-2">
        ...
        <div class="card-footer">
            ...
            <!-- Modal -->
            <div class="modal fade" id="deleteFile" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{ route('user.file.delete') }}" method="post">
                            ...
                            <div class="modal-body">
                                <input type="checkbox" name="file_id" value="{{ $file->id }}"> Saya Setuju menghapus data ini
                            </div>
